package com.liulongling.tool.services.index;

import static org.apache.commons.lang3.StringUtils.substringBeforeLast;

import com.liulongling.tool.AppException;
...
public class PluginManageService {
    ...
    public static final String PLUGIN_LIST_PATH = System.getProperty("user.dir") + File.separator + "system_plugin_list.json";
    ...
    public static boolean isPluginEnabled(String fileName) {
        ...
        log.info("jarName {} pluginJarInfo {}", jarName, pluginJarInfo);
        if (pluginJarInfo == null) {
            return false;
        }
