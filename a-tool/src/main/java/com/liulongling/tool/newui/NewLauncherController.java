package com.liulongling.tool.newui;

import static com.liulongling.tool.utils.BoolUtils.isNot;

import com.liulongling.tool.Main;
import com.liulongling.tool.newui.creator.CreatePluginProjectService;
import com.liulongling.tool.newui.creator.PluginProjectInfo;
import com.liulongling.tool.plugin.PluginManager;
import com.liulongling.tool.plugin.PluginParser;
import com.liulongling.tool.services.index.SystemSettingService;
import com.liulongling.tool.event.AppEvents;
import com.liulongling.tool.event.PluginEvent;
...
public class NewLauncherController {
    ...
    public void openPluginCreator() {
        ...
        FxDialog<PluginCreatorController> dialog = new FxDialog<PluginCreatorController>()
            .setTitle("创建自己的插件")
            .setBodyFxml("/com/liulongling/tool/fxmlView/newui/plugin-creator.fxml")
