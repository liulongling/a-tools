...
import com.liulongling.tool.utils.Config.Keys;
import com.liulongling.tool.utils.StageUtils;
import com.liulongling.tool.utils.XJavaFxSystemUtil;
...
public class Main extends Application {
    ...
    private void loadNewUI(Stage primaryStage) throws IOException {
        ...
        fxmlLoader.setLocation(Main.class.getResource("/com/liulongling/tool/fxmlView/newui/main.fxml"));
